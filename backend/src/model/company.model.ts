...
const companySchema = new Schema(
  {
    ...
    admin: { type: Schema.Types.ObjectId, ref: "admin", required: true }, // Reference to the admin who created the company
    employees: [{ type: Schema.Types.ObjectId, ref: "user" }], // References to users who are employees
